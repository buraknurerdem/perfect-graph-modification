...
int main(int argc, char* argv[]){
    ...
    // if(parameters["SOLVE_FOR_SUBGRAPHS_FOR_VI"] == "1") {SOLVE_FOR_SUBGRAPHS_FOR_VI = 1; }
    // else{ SOLVE_FOR_SUBGRAPHS_FOR_VI = 0; }
    ...
    // -----------------------------------------------------------------------------------------
    // ADD_ALL_AT_START: Add all is not optional in sandwich. It also incorporates the precheck
    ...
    std::string summary;
    // Format:
    // inputGraphFileName,parameterFileName,TIME_LIMIT_SECONDS,ODD_HOLE_TERMINATION_PERCENTAGE,N_THREADS,IS_RUNNING_HEURISTIC_ON_CANDIDATE,IS_RUNNING_HEURISTIC_ON_RELAXATION,ADD_ALL_AT_START,graphOrder,inputGraph_p_Param,ODD_HOLE_TERMINATION_BATCH_SIZE,wallclock(ms),timeInAlgo(ms),AlgoCalls,foundOddHoles,foundOddAntiHoles,isOptimal,optimalityGap,objectiveValue,nFeasibleSolutionsFound,n_times_heuristic_called,n_added_oh_ohbar_cuts,number_of_explored_bc_nodes,number_of_unexplored_bc_nodes,mEdgesInput,inputGraphDensity,mEdgesOutput,outputGraphDensity,isOutputEmptyOrComplete,inputExpOHCount,inputExOHbarCount
    // inputGraphFileName,parameterFileName,TIME_LIMIT_SECONDS,ODD_HOLE_TERMINATION_PERCENTAGE,N_THREADS,graphOrder,inputGraph_p_Param,ODD_HOLE_TERMINATION_BATCH_SIZE,wallclock(ms),time_in_precheck(ms),isFeasible,isInfeasibleByPrecheck,isInfeasibleByCplex,isUnknown
    summary += inputGraphFileName + ",";
    summary += parameterFileName + ",";
    summary += parameters["TIME_LIMIT_SECONDS"] + ",";
    //summary += parameters["OPTIMALITY_GAP_PARAMETER"] + ",";
    ...
    // summary += parameters["SOLVE_FOR_SUBGRAPHS_FOR_VI"] + ",";
    ...
    // summary += std::to_string(programStats.timeSpentInOddHoleAlg / 1000000) + ",";
    // summary += std::to_string(programStats.nOddHoleAlgCalls) + ",";
    // summary += std::to_string(programStats.nOddHoles) + ",";
    // summary += std::to_string(programStats.nOddAntiHoles) + ",";
    // summary += std::to_string(programStats.isOptimal) + ",";
    // summary += std::to_string(programStats.optimalityGap) + ",";
    // summary += std::to_string(programStats.objectiveValue) + ",";
    // summary += std::to_string(programStats.nFeasibleSolutionsFound) + ",";
    // summary += std::to_string(programStats.n_times_heuristic_called) + ",";
    // summary += std::to_string(programStats.n_added_oh_ohbar_cuts) + ",";
    // summary += std::to_string(number_of_explored_bc_nodes) + ",";
    // summary += std::to_string(number_of_unexplored_bc_nodes) + ",";
    // summary += std::to_string(mEdgesInput) + ",";
    // summary += std::to_string(static_cast<double>(mEdgesInput) / nOfVertexPairs) + ",";
    // summary += std::to_string(mEdgesOutput) + ",";
    // summary += std::to_string(static_cast<double>(mEdgesOutput) / nOfVertexPairs) + ",";
